...
<html lang="fr">
    ...
    <body class="container-fluid">
        ...
        <article class="row image-search">
            ...
            <h3 class="col-xs-offset-1 col-xs-10 col-md-offset-2 col-md-8">Trouvez ici facilement le musée que vous cherchiez</h3>

            <form class=" col-xs-offset-1 col-xs-10 col-md-offset-2 col-md-8" action ="recherche.php" method="get">
        ...
        <article class="row last-exhib">
            <div class="square-title col-xs-offset-1 col-xs-10 col-md-offset-1 col-md-4">
                <div class="square"></div>
